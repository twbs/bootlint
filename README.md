...
If you want to use [Gulp](http://gulpjs.com) to run your Bootlint tasks, check out the (unofficial) Gulp plugin: [gulp-bootlint](https://github.com/tschortsch/gulp-bootlint)
