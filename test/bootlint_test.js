...
exports.bootlint = {
    ...
    'jQuery': function (test) {
        ...
        test.deepEqual(lintHtml(utf8Fixture('jquery/old.html')),
            ["An older version of jQuery was detected, please upgrade to version 1.9.0 or higher"],
            'should complain about old version of jQuery');
